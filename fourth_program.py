...
#printing the length of the set it_companies
print(f"length of IT compaines: {len(it_companies)}")

#adding twitter to the set it_companies
it_companies.add('Twitter')
print(f"add Twitter: {it_companies}") #printing it after adding twitter
...
#remove() and discard are almost similar but remove() raises keyerror if element isn't found whereas
#discard doesn't raise an error


#printing join A and B
print(f"join A AND B:{A | B}")

#intersection of A and B printing common elements in A and B
print(f"intersection A AND B:{A & B}")

#printning the subset
